...
int    opterr = TRUE;          /* generate error messages */
int     optind = 1;             /* index into argv array   */
char *  optarg = NULL;          /* optional argument       */
char    optsign = '\0';         /* switch prefix of current opt */


int dxf2rad_getopt( int argc, char *const *argv, const char *optstring )
{
	static   char *opt_ptr = "";
	register char *ptr;
			 int   option;
